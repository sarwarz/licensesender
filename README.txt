...
Automatically deliver license keys for digital WooCommerce products via your LicenseSender App.

== Description ==

LicenseSender connects your WooCommerce store to [LicenseSender](https://licensesender.com) so you can deliver license keys after purchase.

**Features:**

* Map WooCommerce products to LicenseSender SKUs
...
* SSO link to the LicenseSender app

== Installation ==

1. Upload the plugin to `/wp-content/plugins/licensesender/`
2. Activate the plugin through the **Plugins** menu in WordPress
3. Go to **licensesender → Settings → API** and enter your API key
4. Map products under **Products → Edit → licensesender** tab
...
* REST API layer (`licensesender/v1`) with legacy AJAX fallback
